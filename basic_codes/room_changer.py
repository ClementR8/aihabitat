...
# Test scene 
test_scene = os.path.join(data_path, "scene_datasets/hm3d-minival/hm3d-minival-glb-v0.2/00800-TEEsavR23oF/TEEsavR23oF.glb")
...
sim.pathfinder.load_nav_mesh(
    os.path.join(data_path, "scene_datasets/hm3d-minival/hm3d-minival-habitat-v0.2/00800-TEEsavR23oF/TEEsavR23oF.basis.navmesh")
)
...
model = YOLO("/home/intern/habitat-sim/examples/MyCodes/github_repository/image_processing/yolo_model/weights/best.pt") # Custom YOLO model
